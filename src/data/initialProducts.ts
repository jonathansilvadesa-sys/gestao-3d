...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    markup: 8, falhas: 15, imposto: 8, txCartao: 5, custoAnuncio: 20, canalVenda: 'mercadolivre', maoObraHoras: 0, maoObraTaxa: 0,
  ...
  },
  {
    ...
    markup: 5, falhas: 15, imposto: 8, txCartao: 5, custoAnuncio: 20, canalVenda: 'manual', maoObraHoras: 0, maoObraTaxa: 0,
  ...
  },
  {
    ...
    acessorios: [{ nome: 'Embalagem', qtd: 1, custoUn: 2.5 }],
    markup: 2, falhas: 15, imposto: 8, txCartao: 5, custoAnuncio: 20, canalVenda: 'manual', maoObraHoras: 0, maoObraTaxa: 0,
  ...
  },
  {
    ...
    acessorios: [{ nome: 'Embalagem', qtd: 1, custoUn: 2.5 }],
    markup: 4, falhas: 15, imposto: 8, txCartao: 5, custoAnuncio: 20, canalVenda: 'manual', maoObraHoras: 0, maoObraTaxa: 0,

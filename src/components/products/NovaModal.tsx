              ...
              {acessorios.map((a, idx) => (
                <div key={a.id} className={`grid grid-cols-[1fr_80px_90px_32px] gap-2 items-center rounded-xl px-3 py-2 ${a.catalogId ? 'bg-purple-50 border border-purple-100' : 'bg-gray-50'}`}>
                  ...
                  <div>
                    ...
                    <input type="number" inputMode="decimal" min="1" step="1" value={a.qtd} onChange={(e) => updateAcessorio(a.id, 'qtd', e.target.value)}
                  ...
                  <div>
                    ...
                    <input type="number" inputMode="decimal" min="0" step="0.01" value={a.custo} onChange={(e) => updateAcessorio(a.id, 'custo', e.target.value)}

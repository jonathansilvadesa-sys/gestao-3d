...
export function FloatingHelpButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 left-6 z-50 w-12 h-12 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white shadow-xl hover:shadow-2xl transition-all duration-200 flex items-center justify-center font-bold text-lg group"
